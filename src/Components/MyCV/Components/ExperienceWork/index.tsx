    ...
    const arrayExperience: TExperience[] = [
        {
            ...
            tecnologias: ['ReactJs', 'TypeScript', 'Redux', 'MaterialUI', 'Cypress', 'Azure DevOps'],
        },
        {
            ...
            tecnologias: ['SQL Server', 'SSIS', 'SSDT', 'API Rest', 'Azure DevOps'],
        },
        {
            ...
            tecnologias: ['PL/SQL', 'Informatica Power Center', 'Jobs', 'incidencias'],
        },
        {
            ...
            tecnologias: ['PL/SQL', 'Shell Scripting', 'RLM'],
        },
        {
            ...
            tecnologias: ['PL/SQL', 'HP Exstream'],
        },
    ];
